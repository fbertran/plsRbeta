...
```{r, fig.cap="Figure 10. Residuals and simulated envelop.", fig.keep='last'}
...
```{r, fig.cap="Figure 12. Observed values versus predicted values on the logit scale.", fig.keep='last'}
