...
m <- match(c("dataY","dataX","nt","limQ2set","dataPredictY","modele","family","typeVC","EstimXNA","scaleX","scaleY","pvals.expli","alpha.pvals.expli","MClassed","tol_Xi","weights","method","sparse","sparseStop","naive","link","link.phi","type","verbose"), names(mf), 0L)
mf <- mf[c(1L, m)]
